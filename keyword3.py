...
torch.save(happy_gen.model.state_dict(), "happy_gen_model_weights.pt")

import shutil
shutil.copy("/content/happy_gen_model_weights.pt", "/content/drive/MyDrive/happy_gen_model_weights.pt")
